...
class GroupHeader
{
     ...
     */
    function __construct($messageIdentification, $initiatingPartyName, $isTest = false, $initiatingPartyId) {
        $this->messageIdentification = $messageIdentification;
        $this->isTest = $isTest;
        $this->initiatingPartyName = StringHelper::sanitizeString($initiatingPartyName);
        $this->initiatingPartyId = StringHelper::sanitizeString($initiatingPartyId);
